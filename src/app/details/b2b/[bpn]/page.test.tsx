...
import B2BProductDetailPage, { generateMetadata } from '@/app/details/b2b/[bpn]/page';
...
describe('Pages: B2B Product Details Page', () => {
    it('should render the B2B product details page', async () => {
        const params = { bpn: '960120624' };
        const searchParams = { mode: ''};
        productResponseObject.resolvedResponseByBpn = { [params.bpn]: () => {} };
        render(await B2BProductDetailPage({ params, searchParams }));
