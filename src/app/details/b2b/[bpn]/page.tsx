...
const configObj = { programType: '1P_B2B', pageType: 'pdp' };
...
export default async function B2BProductDetailPage({ params, searchParams }: { params: { bpn: string }, searchParams: { mode: string } }) {
                ...
                <div className="full-bleed-row">
                    <div className="product-wrapper-v2 product-wrapper-v2--details section mt-0">
                        <div className="container-fluid px-0 product-details-wrapper" data-bpn={params.bpn} >
                            <PdpSSRContainer productResponseForMetaData={productResponseObject.resolvedResponseByBpn[params.bpn]} banner={banner} config={config} bpn={params.bpn} mode={searchParams.mode} configObj={configObj}
                                            couponsCarousel={<AngularComponents config={config} componentType={'couponsCarousel'} isBannerBelowTheFold={false} configObj={configObj} />}/>
                            <AngularComponents config={config} componentType = {'angularComp'} isBannerBelowTheFold={true} configObj={configObj} />
