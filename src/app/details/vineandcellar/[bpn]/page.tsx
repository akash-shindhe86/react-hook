...
const configObj = { programType: '1P_WINE', pageType: 'pdp'};
...
export default async function ProductDetailPage({ params, searchParams }: { params: { bpn: string }, searchParams: { mode: string } }) {
    ...
    return (
        <main className="main-wrapper nextgen-main-wrapper" data-program = "wineshop">
                    ...
                    <div className="product-wrapper-v2 product-wrapper-v2--details section mt-0">
                        <div className="container-fluid px-0 product-details-wrapper" data-bpn={params.bpn} >
                            <PdpSSRContainer productResponseForMetaData={productResponseObject.resolvedResponseByBpn[params.bpn]} banner={banner} config={config} bpn={params.bpn} mode={searchParams.mode} configObj={configObj}
                                             couponsCarousel={<AngularComponents config={config} componentType={'couponsCarousel'} configObj={configObj}/>}/>
